...
Followed by another line of abnormal text with `inline code` and *italics*, **strong font**, and even some μ†ℱ ╋ℯ╳╋. Followed by lots of Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis id sem purus, eu commodo tortor. Donec malesuada ultricies dolor a eleifend. In hac habitasse platea dictumst. Vivamus a faucibus ligula. Nullam molestie tristique arcu, eu elementum metus ultricies sed. Aenean luctus congue lectus, vitae semper erat rhoncus non. Nulla facilisi.
...
main = do
  ...
  let readerOptions = def {
      ...
      (res, warnings) = readMarkdownWithWarnings readerOptions conts
      newFile = writeHtmlString writerOptions res
  writeFile "test.html" newFile
  writeFile "kate.css" $ styleToCss tango
